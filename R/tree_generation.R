...
#' optionally rooting the tree on a given tip.  Trees are generated by inserting
#' each tip in term at a randomly selected edge in the tree.  Random numbers
#' are generated using a Mersenne Twister.
#'
#' @examples
