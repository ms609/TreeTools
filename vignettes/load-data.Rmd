...
`TreeTrunk` contains an inbuilt Nexus parser:
...
[let me know](https://github.com/ms609/TreeTrunk/issues/new?title=Unsupported+NEXUS+file&body=Please%20attach%20the%20problematic%20NEXUS%20file%20and%20describe%20the%20issue&labels=enhancement)
...
[let me know](https://github.com/ms609/TreeTrunk/issues/new?title=Unsupported+TNT+file&body=Please%20attach%20the%20problematic%20TNT%20file%20and%20describe%20the%20issue&labels=enhancement)
and I'll try to fix it.
...
[let me know](https://github.com/ms609/TreeTrunk/issues/new?title=data+to+PhyDat+conversion+issue&body=Please%20describe+the+problem+here:&labels=bug).  


Failing that, you can enlist the help of the
`phangorn` package, which was installed when you installed `TreeTrunk`:
