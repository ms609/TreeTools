# benchmarks/compare_results.R

# Load benchmarking library
library("microbenchmark")

# Load the results
pr_results <- readRDS("pr-benchmark-results/benchmark_results.rds")
main_results <- readRDS("main-benchmark-results/benchmark_results.rds")
