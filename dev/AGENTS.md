...
> [`../AGENTS.md`](https://ms609.github.io/TreeTools/AGENTS.md)** for
> multi-agent coordination rules, build/test infrastructure, GHA
> workflows, and worktree discipline. That file is the authoritative
> reference for all cross-package agent operations.
