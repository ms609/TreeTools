...
- New method
  [`as.Splits.integer()`](https://ms609.github.io/TreeTools/reference/Splits.md).
...
- Remove R.cache dependency:
  [`UnrootedKeys()`](https://ms609.github.io/TreeTools/reference/TreeShape.md)
...
- Support node labels in
  ...
  [`Reorder()`](https://ms609.github.io/TreeTools/reference/Reorder.md),
...
- [`DropTip()`](https://ms609.github.io/TreeTools/reference/DropTip.md)
  gains new methods
  [`DropTip.list()`](https://ms609.github.io/TreeTools/reference/DropTip.md)
  and
  [`DropTip.NULL()`](https://ms609.github.io/TreeTools/reference/DropTip.md).
...
- [`TntOrder()`](https://ms609.github.io/TreeTools/reference/Reorder.md)
...
- [`KeepTip.Splits()`](https://ms609.github.io/TreeTools/reference/DropTip.md)
...
- [`PostorderOrder()`](https://ms609.github.io/TreeTools/reference/Reorder.md)
...
- Support edge lengths in
  ...
  and
  [`Postorder()`](https://ms609.github.io/TreeTools/reference/Reorder.md)
...
- Export
  ...
  as wrapper to
  [`DropTip.phylo()`](https://ms609.github.io/TreeTools/reference/DropTip.md).
...
- Add
  [`TipLabels.phyDat()`](https://ms609.github.io/TreeTools/reference/TipLabels.md)
  method.
...
- Add
  [`NTip.phyDat()`](https://ms609.github.io/TreeTools/reference/NTip.md)
  method.
- Update
  [`MakeTreeBinary()`](https://ms609.github.io/TreeTools/reference/MakeTreeBinary.md)
